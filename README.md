...
| Filters | `sptk/filter` | `fir`, `iir`, `savgol`, `movavg`, `medfilt`, `dcblock`, `detrend`, `hampel`, `adaptive`, `rls`, `resample`, `filtfilt` | Take a band of frequencies away, or smooth a signal |
