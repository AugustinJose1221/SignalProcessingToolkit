// This file is left out of the build when FFITT_NO_ESTIMATE is defined.
// ffitt/core/README.md says which areas may be left out and
// which of them need which others.
#ifndef FFITT_NO_ESTIMATE
...
typedef int propagate_is_not_in_this_build_t;

#endif//FFITT_NO_ESTIMATE
